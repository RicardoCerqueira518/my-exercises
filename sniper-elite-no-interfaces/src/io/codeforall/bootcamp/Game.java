    ...
    private GameObject[] createGameObjects(int numberObjects) {
        ...
        for (int i = 0; i < gameObjects.length; i++) {
            ...
            if (choose < 1) {
                ...
                System.out.println("criaste uma arvore boi!");
                continue;
            }
            if (choose < 2) {
                gameObjects[i] = GameObjectFactory.createEnemy();
                System.out.println("criaste uma inimigo boi!");
                continue;
            }
            if (choose < 3) {
                gameObjects[i] = GameObjectFactory.createEnemy();
            ...
            System.out.println("criaste uma barril boi!");
                gameObjects[i] = GameObjectFactory.createBarrel();
